odoo.define('point_of_sale.ClientListScreen2', function(require) {
    'use strict';
     ...
     */
    class ClientListScreen2 extends PosComponent {
        constructor() {
            super(...arguments);
    ...
    ClientListScreen2.template = 'ClientListScreen2';

    Registries.Component.add(ClientListScreen2);

    return ClientListScreen2;
});
