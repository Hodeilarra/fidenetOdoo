...
class UpdateRepair(models.Model):
	...
	def copy(self, default=None):
		...
		self.codigo_barras = self.name
		partes = self.codigo_barras.split("/")
		self.codigo_barras = "".join(partes)
		default.update({'codigo_barras': self.codigo_barras}) 
